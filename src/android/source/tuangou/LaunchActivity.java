...
public class LaunchActivity extends Activity{
	...
	public void onCreate(Bundle bundle){
		...
		if (VersionManager.checkClientUpdate()){
			...
			android.app.AlertDialog.Builder builder1 = builder.setTitle(s).setMessage(R.string.new_apk_text);

			OnClickListener1 mOnClickListener1 = new OnClickListener1();
			android.app.AlertDialog.Builder builder2 = builder1.setPositiveButton(R.string.dlg_positive, mOnClickListener1);
			
			OnClickListener2 mOnClickListener2 = new OnClickListener2();
			builder2.setNegativeButton(R.string.dlg_negative, mOnClickListener2).create().show();
		} else{
			//不需要更新，做其他工作
			doOtherJobs();
		}
	...
	private class Handler1 extends Handler{
		...
		public void handleMessage(Message message){
			...
			case 5:
				...
				textview.setText(s);
				if (message.arg1 == 100)
					Toast.makeText(LaunchActivity.this, "更新完成", 0).show();
				break;
	...
	//控件点击监听函数
	private class OnClickListener2
		implements android.content.DialogInterface.OnClickListener{
