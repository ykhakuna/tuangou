...
public class MainActivity extends ActivityGroup {
	...
	private void initRadios() {
		...
		((RadioButton) findViewById(R.id.btn_tab_today_deals))
				.setOnCheckedChangeListener(mCheckedChangeListener);
		((RadioButton) findViewById(R.id.btn_tab_near_deals))
				.setOnCheckedChangeListener(mCheckedChangeListener);
		((RadioButton) findViewById(R.id.btn_tab_my_deals))
				.setOnCheckedChangeListener(mCheckedChangeListener);
		((RadioButton) findViewById(R.id.btn_tab_more_deals))
				.setOnCheckedChangeListener(mCheckedChangeListener);
	}
	...
	// 控件状态监听器
	private class CheckedChangeListener implements
		...
		public void onCheckedChanged(CompoundButton compoundbutton, boolean flag) {
			if (!flag) {
				...
				case R.id.btn_tab_today_deals:
					openStack("daily_deals", "category.html",
							R.string.daily_deals);
					break;

				// 附件团购
				case R.id.btn_tab_near_deals:
					openStack("near_deals", "nearby.html",
							R.string.nearby_deals);
					break;
